...
class Interpreter {
  ...
  evaluateTree() {
     ...
     */
    _programBody.forEach((element) {
      _evaluateStatement(element);
    });
  }
  ...
  _evaluateForStatement(Map<String, dynamic> tree) {
    ...
    while (result["value"]) {
      _evaluateBlockStatements(tree["body"]["body"]);
  ...
  _evaluateBlockStatements(List<dynamic> body) {
    ...
    body.forEach((statement) => _evaluateStatement(statement));
  }
  ...
  _evaluateIfStatement(Map<String, dynamic> tree) {
    ...
    if (result["value"]) {
      _symbolTable.allocate();
      _evaluateBlockStatements(tree["consequent"]["body"]);
      _symbolTable.free();
    } else {
      if (tree["alternate"] != null) {
        if (tree["alternate"]["type"] == TreeNodeTypes.IfStatement) {
          ...
          _symbolTable.allocate();
          _evaluateBlockStatements(tree["alternate"]["body"]);
          _symbolTable.free();
        }
      }
    }
  ...
  _evaluateStatement(Map<String, dynamic> statement) {
    ...
    switch (statement["type"]) {
      ...
      case TreeNodeTypes.IfStatement:
        _evaluateIfStatement(statement);
        break;
